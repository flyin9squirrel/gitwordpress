...
Author: Rich Hildred Version: 1.0 Author URI: http://syndicateme.net/
 */
class MigratePages {
	...
	public static function export() {
		...
		file_put_contents ( ABSPATH . 'wp-content/uploads/pages.sql', $sHeading );
		...
		foreach ( $aResults as $nRow => $aRow ) {
			...
			$sRow .= "')";
			file_put_contents ( ABSPATH . 'wp-content/uploads/pages.sql', $sRow, FILE_APPEND );
		}
